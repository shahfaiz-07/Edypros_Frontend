...
const VideoModal = ({modalData, setModalData, add, view, edit}) => {
  ...
  return (
    ...
    <div className='my-10 w-11/12 max-w-[700px] rounded-lg border border-richblack-400 bg-richblack-800'>
        <p className='text-white px-6 py-3 bg-richblack-600 flex justify-between'><span>{view && "Viewing"}{add && "Adding"}{edit && "Editing"} Lecture</span> <span><i className="ri-close-large-line text-richblack-300 hover:text-richblack-5 cursor-pointer" onClick={()=>setModalData(null)}></i></span></p>
      ...
      <div className='flex flex-col space-y-2'>
        ...
        {
            (edit || add) && (
                <button type='submit' className='px-4 py-2 font-semibold rounded bg-yellow-50'>
