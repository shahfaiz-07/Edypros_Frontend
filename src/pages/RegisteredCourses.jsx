                ...
                registeredCourses.map( (course) => (
                    <div key={course._id} className='px-3 py-4 flex lg:border-b border-richblack-500 rounded-lg lg:rounded-none bg-richblack-800 lg:bg-richblack-900 hover:bg-opacity-40'>
                        ...
                        <div className='flex flex-col h-full justify-between'>
                            ...
                            <h2 className='text-richblack-5 text-ellipsis hover:underline cursor-pointer' onClick={() => navigate(`/view-course/${course.courseId._id}/${course.courseId.sections[0]._id}/${course.courseId.sections[0].videos[0]._id}`)}>{course.courseId.name.slice(0, 30)} {course.courseId.name.length > 30 && "..."}</h2>
